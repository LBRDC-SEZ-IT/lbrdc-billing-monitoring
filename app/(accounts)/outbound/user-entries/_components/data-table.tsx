...
import DataTableFilterStatus from "@/components/data-table-filter-status";
import { DataTablePagination } from "@/components/data-table-pagination";
import DataTableToggleColumn from "@/components/data-table-toggle-column";
import DialogAddAccountOutbound from "@/components/dialog-add-account-outbound";
    ...
    <div className="space-y-4">
      <div className="flex items-center gap-4">
        ...
        <DataTableFilterStatus
          table={table}
          data={data}
          excludedStatuses={isManager ? ["Rejected", "Approval"] : []}
        />
        <DialogAddAccountOutbound className="ml-auto" />
              ...
              <TableRow>
                <TableCell colSpan={columns.length} className="py-12">
                  <div className="flex flex-col justify-center items-center">
                    ...
                    <span className="max-w-lg text-muted-foreground text-pretty text-center">
                      You can add new record with the &#34;Add Account&#34; button.
                    </span>
                  </div>
                </TableCell>
              </TableRow>
