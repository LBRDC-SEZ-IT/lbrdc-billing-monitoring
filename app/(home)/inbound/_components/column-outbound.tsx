...
import { ActionCellOutbound } from "./data-table-action-outbound";
...
export const columnOutbound: ColumnDef<OutboundView>[] = [
  {
    id: "clientInfo",
    size: 350,
    enableHiding: false,
    accessorFn: (row) => `${row._id} ${row.code} ${row.clientName}`,
    header: ({ column }) => (
  ...
  },
  {
    ...
    enableHiding: false,
    size: 10,
    cell: (props) => <ActionCellOutbound {...props} />,
  },
];
